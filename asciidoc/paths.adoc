...
**Headers** :  +
`x-jws-signature` (string) : Header containing a detached JWS signature of the body of the payload.|<<_payment_submit_post_201_response,Payment Submit POST 201 Response>>
...
**Headers** :  +
`x-jws-signature` (string) : Header containing a detached JWS signature of the body of the payload.|<<_payment_setup_post_response,Payment setup POST response>>
|**400**|Bad Request|No Content
|**401**|Unauthorized|No Content
|**403**|Forbidden|No Content
|**500**|Internal Server Error|No Content
