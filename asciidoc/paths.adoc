...
__optional__|DO NOT USE. Header containing a detached JWS signature of the body of the payload.|string
|===
...
**Headers** :  +
`x-jws-signature` (string) : DO NOT USE. Header containing a detached JWS signature of the body of the payload. +
