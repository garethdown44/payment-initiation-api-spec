...
|**Path**|**PaymentId** +
__required__|ASPSP identifier for the payment setup resource|string
|===
...
**Length** : `3 - 4`|string
|**PaymentId** +
__required__|ASPSP identifier for the payment setup resource +
**Length** : `1 - 35`|string
...
|Name|Description|Schema
|**CreatedAt** +
__required__|UTC time when the resource was created|string (date-time)
|**Links** +
...
**Length** : `1 - 35`|string
|**PaymentSubmissionId** +
__required__|ASPSP identifier for the payment submission resource +
**Length** : `1 - 35`|string
|**Status** +
__required__|Status of the payment setup resource|enum (AcceptedSettlementInProcess, AcceptedSettlementCompleted, Received, Failed)
|===
...
__required__|ASPSP identifier for the payment submission resource|string
|===
...
**Length** : `1 - 140`|string
|**Status** +
__required__|Status of the payment setup resource|enum (Pending, AcceptedTechnicalValidation, AcceptedCustomerProfile)
|===
