...
|Name|Description|Schema
|**CreditorAccount** +
__required__|Unambiguous identification of the account of the creditor to which a credit entry will be posted as a result of the payment transaction.|<<_debtor_account,Debtor Account>>
|**CreditorAgent** +
...
|**CountrySubDivision** +
__optional__|Identifies a subdivision of a country, for instance state, region, county. +
**Length** : `1 - 35`|string
|**PostCode** +
